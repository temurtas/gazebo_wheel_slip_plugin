 ...
 *
*/
#ifndef GAZEBO_PLUGINS_HTNAVGAZEBOWHEELSLIPPLUGIN_HH_
#define GAZEBO_PLUGINS_HTNAVGAZEBOWHEELSLIPPLUGIN_HH_
...
namespace gazebo
{
  ...
  /** \verbatim
    ...
    <plugin filename="libHTNavGazeboWheelSlipPlugin.so" name="wheel_slip">
   ...
   \endverbatim */
  class GZ_PLUGIN_VISIBLE HTNavGazeboWheelSlipPlugin : public ModelPlugin
  {
    /// \brief Constructor.
    public: HTNavGazeboWheelSlipPlugin();

    /// \brief Destructor.
    public: virtual ~HTNavGazeboWheelSlipPlugin();
    ...
    public: void LinkStateSolver(double position[3], double velocity[3], double euler[3], physics::LinkPtr link);
    ...
    private: std::unique_ptr<HTNavGazeboWheelSlipPluginPrivate> dataPtr;
  };
}
#endif
